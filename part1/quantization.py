...
#     data_dir = Path("/home/z004x2xz/miscExcersises/himanshushukla12/ML-Engineer-Challenge/tiny-imagenet-200/tiny-imagenet-200/test")
...
#     times = []
#     model = model.to(device)
#     scaler = torch.cuda.amp.autocast() if use_amp else None
...
#     print(f"Speedup from FP32 to FP16: {orig_time_fp32 / orig_time_fp16:.2f}x")
